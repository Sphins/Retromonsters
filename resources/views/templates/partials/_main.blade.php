        ...
        <div class="md:flex">
          ...
          <div class="w-full md:w-1/2 relative">
            <img
              ...
              src="/storage/img//aqualizzard.png"
              alt="Nom du Monstre"
            />
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <img
            ...
            src="/storage/img//aquadragon.png"
            alt="AbyssalRevenant"
          />
          <div class="p-4">
        ...
        >
          <img
            class="w-full h-48 object-cover rounded-t-lg"
            src="/storage/img//shadowmonkey.png"
            alt="AbyssalRevenant"
          />
          <div class="p-4">
        ...
        >
          <img
            class="w-full h-48 object-cover rounded-t-lg"
            src="/storage/img//spiritshade.png"
            alt="CosmicGleam"
          />
          <div class="p-4">
    ...
    <section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <img
            class="w-full h-48 object-cover rounded-t-lg"
            src="/storage/img//earthelemental.png"
            alt="AbyssalRevenant"
          />
          <div class="p-4">
            <h3 class="text-xl font-bold">AbyssalRevenant</h3>
        ...
        >
          <img
            class="w-full h-48 object-cover rounded-t-lg"
            src="/storage/img//rockmountain.png"
            alt="AbyssalRevenant"
          />
          <div class="p-4">
            <h3 class="text-xl font-bold">GrimmShadow</h3>
